...
rect47=createButton("Move left")
rect47.position(width/1.5-width/2,height/2+50)
...
rect21.y=base.y
  ...
  if(diamond>2){
    text("Husky is located at x=-403,y=165",width/.8-width/2,height/2-270)
  }
  if(diamond>3){
    text("German Shepard puppy is located at x=-421,y=-94",width/.82-width/2,height/2-250)
  }
